          ...
          <div>
            ...
            <div class="flex">
              <div class="w-3/12 text-center px-6">
                <div class="bg-sky-300 rounded-lg flex items-center justify-center border border-sky-200">
                  <div
                    ...
                    <p class="text-xs" :class="classStep1Label">Pilih Tempat Prakerin</p>
                  </div>
                </div>
              </div>
              ...
              <div class="w-4/12 text-center px-6">
                <div class="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200">
                  <div
                    ...
                    <p class="text-xs" :class="classStep2Label">Upload Berkas</p>
                  </div>
                </div>
              </div>
              <div class="flex-1 flex items-center justify-center">
              ...
              <div class="w-3/12 text-center px-6">
                <div class="bg-gray-300 rounded-lg flex items-center justify-center border border-gray-200"
                  ...
                  <div
                    ...
                    <p class="text-xs" :class="classStep3Label">Tunggu Acc</p>
                  </div>
                </div>
              </div>
            </div>
