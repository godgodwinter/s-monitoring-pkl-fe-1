...
<template>
  ...
  <div class="static bg-white" v-if="!isSidebarActive">
    <div class="fixed z-50 w-full font-serif font-semibold text-sm bg-slate-700 text-white flex justify-center py-2">
      ...
      <div class="w-full">
        <div class="flex justify-between px-3 pt-2 pb-4">
          <router-link :to="{ name: 'LandingIndex' }" class="flex px-2 py-0 w-2/5">
            ...
            <h3 class="pt-2 lg:pt-0 ml-4 mt-1 text-md font-bold text-gray-800 hover:text-sky-600 hover:underline">
              SMK DW KROMENGAN
            </h3>
          </router-link>
          <div class="md:w-3/5">
            <div class="hidden md:block">
              <div class="flex justify-end gap-10 pt-2">
                <!-- <router-link :to="{ name: 'LandingIndex' }"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Home</router-link> -->
                <router-link :to="{ name: 'LandingSiswa' }"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Siswa</router-link>
                <a href="http://localhost:3002" target="_blank"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Pembimbing
                  Lapangan</a>
                <a href="http://localhost:3003" target="_blank"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Pembimbing
                  Sekolah</a>
                <a href="http://localhost:3004" target="_blank"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Administrator
                </a>
                ...
                <router-link :to="{ name: 'LandingPengawasSekolah' }"
                  ...
                  Sekolah</router-link>
                <a :href="linkAdmin"
                  class="text-gray-800 font-normal text-sm hover:text-sky-600 hover:underline">Administrator</a> -->
            ...
            <span @click="sidebarToggle" class="text-gray-600 text-xl md:hidden block">
              <svg v-if="!isSidebarActive" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                viewBox="0 0 50 50" style="fill: #000000">
                <path d="M 0 9 L 0 11 L 50 11 L 50 9 Z M 0 24 L 0 26 L 50 26 L 50 24 Z M 0 39 L 0 41 L 50 41 L 50 39 Z">
                </path>
              </svg>
              <svg class="w-8 h-8" v-else width="50" height="50" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                clip-rule="evenodd">
                <path
