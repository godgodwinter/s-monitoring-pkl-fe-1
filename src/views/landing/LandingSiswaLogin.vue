...
const doLogin = async (username, password) => {
  try {
    ...
    if (response.code === 200) {
      ...
      router.push({ name: "PagesSiswaIndex" });
...
<template>
  <div class="bg-white flex flex-col justify-center sm:py-32">
    <div class="relative py-0 sm:max-w-xl sm:mx-auto">
      <div
        class="absolute inset-0 bg-gradient-to-r from-base-300 to-base-200 shadow-lg transform -skew-y-2 sm:skew-y-0 sm:-rotate-2 sm:rounded-3xl">
      </div>
